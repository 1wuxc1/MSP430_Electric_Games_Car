...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
#define CE_PORT     GPIO_PORT_P8
#define CE_PIN      GPIO_PIN1

#define CSN_PORT    GPIO_PORT_P2
#define CSN_PIN     GPIO_PIN7

#define IRQ_PORT    GPIO_PORT_P8
#define IRQ_PIN     GPIO_PIN2
/*
#define NRF24L01_CE   PAout(4) //24L01片选信号
#define NRF24L01_CSN  PCout(4) //SPI片选信号	   
#define NRF24L01_IRQ  PCin(5)  //IRQ主机数据输入
*/
#define NRF24L01_CE_H()     GPIO_setOutputHighOnPin(CE_PORT,CE_PIN)
#define NRF24L01_CE_L()     GPIO_setOutputLowOnPin(CE_PORT,CE_PIN)

#define NRF24L01_CSN_H()    GPIO_setOutputHighOnPin(CSN_PORT,CSN_PIN)
#define NRF24L01_CSN_L()    GPIO_setOutputLowOnPin(CSN_PORT,CSN_PIN)

#define NRF24L01_IRQ()      GPIO_getInputPinValue(IRQ_PORT,GPIO_PIN2)
